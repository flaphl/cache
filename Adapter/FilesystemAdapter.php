...
/**
 * Filesystem cache adapter that stores cache items as files.
 * 
 * This adapter provides persistent caching by storing items in the filesystem.
 * It supports expiration, metadata, and efficient file-based operations.
 */
class FilesystemAdapter implements AdapterInterface
{
    ...
    public function getStats(): array
    {
        ...
        return [
            ...
            'memory_usage' => 0, // Not applicable for filesystem
    ...
    private function getKeyFromFilePath(string $filePath): string
    {
        ...
        return basename($filePath, '.cache');
    }
